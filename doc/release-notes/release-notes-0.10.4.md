CounosH Core version 0.10.4 is now available from:

  <https://counosh.org/bin/counosh-core-0.10.4/>
...
- #6953 `43c2789` Split counosh-tx into its own package
- #6953 `dfe0d4d` Include counosh-tx binary on Debian/Ubuntu
