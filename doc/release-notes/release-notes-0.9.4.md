CounosH Core version 0.9.4 is now available from:

  https://counosh.org/bin/0.9.4/
...
this update is incompatible with the CounosH system and could lead to consensus
forks.

CounosH Core released binaries from https://counosh.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~counosh/+archive/ubuntu/counosh
- A third-party or self-compiled CounosH Core

upgrade to CounosH Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
