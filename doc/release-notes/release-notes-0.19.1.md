...
CounosH Core version 0.19.1 is now available from:

  <https://counoshcore.org/bin/counosh-core-0.19.1/>
...
From CounosH Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as CounosH Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, CounosH Core does not yet change appearance when
...
- #17488 fix "counoshd already running" warnings on macOS (fanquake)
...
[Transifex](https://www.transifex.com/counosh/counosh/).
