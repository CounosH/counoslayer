CounosH Core version 0.9.2.1 is now available from:

  https://counosh.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 CCH to 0.01 CCH
...
- Fix "Start counosh on system login"
