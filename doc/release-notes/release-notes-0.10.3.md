CounosH Core version 0.10.3 is now available from:

  <https://counosh.org/bin/counosh-core-0.10.3/>
...
(see https://github.com/counosh/counosh/pull/6793, as well as the 0.11.0
