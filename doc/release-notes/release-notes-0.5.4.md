CounosH version 0.5.4 is now available for download at:
http://sourceforge.net/projects/counosh/files/CounosH/counosh-0.5.4/
...
http://gitorious.org/counosh/counoshd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix CounosH-Qt notifications under Growl 1.3.
Increase required age of CounosH-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCounosH properly when installing CounosH-Qt over it. (Windows)
