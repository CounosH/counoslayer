CounosH Core version *0.15.2* is now available from:

  <https://counoshcore.org/bin/counosh-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in counosh-tx (TheBlueMatt)
