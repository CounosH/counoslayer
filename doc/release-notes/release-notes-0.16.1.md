CounosH Core version 0.16.1 is now available from:

  <https://counoshcore.org/bin/counosh-core-0.16.1/>
...
- #12843 `df38b13` Test starting counoshd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure counoshd processes are cleaned up when tests end (sdaftuar)
