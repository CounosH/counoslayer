CounosH version 0.7.2 is now available from:
  http://sourceforge.net/projects/counosh/files/CounosH/counosh-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused CounosH-Qt to crash on Windows when exiting.
