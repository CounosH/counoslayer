CounosH-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/counosh/files/CounosH/counosh-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the CounosH
...
New/changed settings (command-line or counosh.conf file)
--------------------------------------------------------
