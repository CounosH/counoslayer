CounosH Core version 0.13.2 is now available from:

  <https://counosh.org/bin/counosh-core-0.13.2/>
...
- #8908 `4a974b2` Update counosh-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow counosh-tx to create v2 transactions (btcdrak)
