...
This document provides guidelines for internationalization of the CounosH Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `counosh_en.ts` remains unchanged.
