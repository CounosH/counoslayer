...
(define* (make-counosh-cross-toolchain target
                                  #:key
...
desirable for building CounosH Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-counosh-cross-toolchain "i686-linux-gnu")
       (make-counosh-cross-toolchain "x86_64-linux-gnu")
       (make-counosh-cross-toolchain "aarch64-linux-gnu")
       (make-counosh-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-counosh-cross-toolchain "riscv64-linux-gnu"
