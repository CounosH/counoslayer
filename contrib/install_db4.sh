...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the counosh repository."
  exit 1
fi
...
# See https://github.com/counosh/counosh/issues/16064
...
echo 'When compiling counoshd, run `./configure` in the following way:'
echo
