...
class CounosFreeDExVersionsSpec(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        txid = self.nodes[0].counos_send(address, fundedAddress, currencyOffered, "0.5")
        self.nodes[0].generatetoaddress(1, coinbase_address)
        ...
        fundedAddress = self.nodes[0].getnewaddress()
        self.nodes[0].sendtoaddress(fundedAddress, "0.1")
        txid = self.nodes[0].counos_send(address, fundedAddress, currencyOffered, "0.3")
        self.nodes[0].generatetoaddress(1, coinbase_address)
        ...
        # Transaction should be invalid, counos_gettransaction will throw
        thrown = False
        try:
            offerTx = self.nodes[0].counos_gettransaction(offerTxid)
...
if __name__ == '__main__':
    CounosFreeDExVersionsSpec().main()
