...
"""Test Counos deactivation."""

from test_framework.test_framework import BitcoinTestFramework
from test_framework.util import assert_equal

class CounosDeactivation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].counos_sendissuancefixed(address, 1, 1, 0, "Z_TestCat", "Z_TestSubCat", "Z_IndivisTestProperty", "Z_TestURL", "Z_TestData", "10000000")
        self.nodes[0].generatetoaddress(1, coinbase_address)
        ...
        txid = self.nodes[0].counos_sendactivation(address, 8, activation_block, 999)
        self.nodes[0].generatetoaddress(1, coinbase_address)
        ...
        txid = self.nodes[0].counos_sendtrade(address, 3, "2000", 4, "1.0")
        self.nodes[0].generatetoaddress(1, coinbase_address)
        ...
        orders = self.nodes[0].counos_getorderbook(3, 4)
        if not orders:
        ...
        txid = self.nodes[0].counos_senddeactivation(address, 8)
        self.nodes[0].generatetoaddress(1, coinbase_address)
        ...
        txid = self.nodes[0].counos_sendtrade(address, 3, "2000", 1, "1.0")
        self.nodes[0].generatetoaddress(1, coinbase_address)
        ...
        txid = self.nodes[0].counos_sendtrade(address, 4, "2000", 1, "1.0")
        self.nodes[0].generatetoaddress(1, coinbase_address)
        ...
        # Sending the deactivation & checking it was valid...
        txid = self.nodes[0].counos_senddeactivation(address, 2)
        self.nodes[0].generatetoaddress(1, coinbase_address)
        ...
        # Check that the order book is empty for a Counos trade
        orders = self.nodes[0].counos_getorderbook(3, 1)
        if orders:
            raise AssertionError("Orderbook should be empty.")

        # Check that the order book is empty for a Counos trade
        orders = self.nodes[0].counos_getorderbook(4, 1)
        if orders:
            raise AssertionError("Orderbook should be empty.")

        # Checking the trade for #3/#1 was refunded...
        balance = self.nodes[0].counos_getbalance(address, 3)['balance']
        assert_equal(balance, "10000000")

        # Checking the trade for #4/#1 was refunded...
        balance = self.nodes[0].counos_getbalance(address, 4)['balance']
        ...
        txid = self.nodes[0].counos_sendtrade(address, 1, "1.0", 4, "1.0")
        self.nodes[0].generatetoaddress(1, coinbase_address)
