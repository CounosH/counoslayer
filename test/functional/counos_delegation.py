...
class CounosDelegation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            node.counos_sendgrant(delegate_address, sink_address, 3, "55")
        except:
            assert_equal(1, 1)
        else:
        ...
        try:
            node.counos_sendadddelegate(unrelated_address, 3, delegate_address)
        except:
            assert_equal(1, 1)
        else:
        ...
        try:
            node.counos_sendremovedelegate(issuer_address, 3, unrelated_address)
        except:
            assert_equal(1, 1)
        else:
        ...
        try:
            node.counos_sendremovedelegate(delegate_address, 3, unrelated_address)
        except:
            assert_equal(1, 1)
        else:
        ...
        try:
            node.counos_sendremovedelegate(delegate_address, 3, delegate_address)
        except:
            assert_equal(1, 1)
        else:
        ...
        try:
            node.counos_sendremovedelegate(issuer_address, 3, delegate_address)
        except:
            assert_equal(1, 1)
        else:
        ...
        try:
            node.counos_sendenablefreezing(delegate_address, 3)
        except:
            assert_equal(1, 1)
        else:
        ...
        try:
            node.counos_senddisablefreezing(delegate_address, 3)
        except:
            assert_equal(1, 1)
        else:
        ...
        try:
            node.counos_sendfreeze(issuer_address, sink_address, 3, "1000")
        except:
            assert_equal(1, 1)
        else:
        ...
        try:
            node.counos_sendfreeze(delegate_address, sink_address, 3, "1000")
        except:
            assert_equal(1, 1)
        else:
        ...
        try:
            node.counos_sendgrant(sink_address, sink_address, 3, "50")
        except:
            assert_equal(1, 1)
        else:
        ...
        try:
            node.counos_sendgrant(delegate_address, sink_address, 3, "77")
        except:
            assert_equal(1, 1)
        else:
        ...
        try:
            node.counos_sendgrant(issuer_address, sink_address, 3, "45")
        except:
            assert_equal(1, 1)
        else:
