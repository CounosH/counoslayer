...
class TestShell:
    """Wrapper Class for CounosHTestFramework.

    The TestShell class extends the CounosHTestFramework
    ...
    class __TestShell(CounosHTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by CounosHTestFramework child class.
            self.num_nodes = 1
