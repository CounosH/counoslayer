...
class CounosClientExpiry(BitcoinTestFramework):
    def set_test_params(self):
        self.num_nodes = 1
        self.setup_clean_chain = True
        self.extra_args = [['-counosalertallowsender=any']]
    ...
    def run_test(self):
        ...
        self.nodes[0].counos_sendalert(address, 3, 999999999, "Client version out of date test.")
