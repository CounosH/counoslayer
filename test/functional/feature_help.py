...
"""Verify that starting counosh with -h works as expected."""

from test_framework.test_framework import CounosHTestFramework
from test_framework.util import assert_equal

class HelpTest(CounosHTestFramework):
    ...
    def run_test(self):
        self.log.info("Start counosh with -h for help text")
        ...
        self.log.info("Start counosh with -version for version information")
        ...
        self.log.info("Start counoshd with -fakearg to make sure it does not start")
