...
class P2PPermissionsTests(CounosHTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].counoshconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].counoshconf, 'w', encoding="utf8") as f:
            f.write(newText)
