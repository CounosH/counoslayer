...
class AvoidReuseTest(CounosHTestFramework):
    ...
    def test_fund_send_fund_senddirty(self):
        '''
        Test the same as test_fund_send_fund_send, except send the 10 CCH with
        the avoid_reuse flag set to false. This means the 10 CCH send should succeed,
    ...
    def test_fund_send_fund_send(self, second_addr_type):
        ...
        [0] sends 10 CCH to A.
        [1] spends 5 CCH from A. (leaving roughly 5 CCH useable)
        [0] sends 10 CCH to A again.
        [1] tries to spend 10 CCH (fails; dirty).
        [1] tries to spend 4 CCH (succeeds; change address sufficient)
        '''
