...
"""Test Counos fee cache."""

from test_framework.test_framework import BitcoinTestFramework
from test_framework.util import assert_equal

class CounosFeeCache(BitcoinTestFramework):
    def set_test_params(self):
        self.num_nodes = 1
        self.setup_clean_chain = True
        self.extra_args = [['-counosactivationallowsender=any', '-disabledevmsc=1']]
    ...
    def run_test(self):
        ...
        txid = node.sendmany("", {"cch1qrhk2ea3ce8uw76alqr69glwng84np2nvde0lq3": 10, address: 4})
        node.generatetoaddress(1, coinbase_address)
        ...
        node.counos_sendissuancefixed(address, 1, 1, 0, "Z_TestCat", "Z_TestSubCat", "Z_IndivisTestProperty", "Z_TestURL", "Z_TestData", "10000000")
        node.generatetoaddress(1, coinbase_address)
        ...
        node.counos_sendissuancefixed(address, 1, 2, 0, "Z_TestCat", "Z_TestSubCat", "Z_DivisTestProperty", "Z_TestURL", "Z_TestData", "10000")
        node.generatetoaddress(1, coinbase_address)
        ...
        node.counos_sendissuancefixed(address, 2, 1, 0, "Z_TestCat", "Z_TestSubCat", "Z_IndivisTestProperty", "Z_TestURL", "Z_TestData", "10000000")
        node.generatetoaddress(1, coinbase_address)

        # Creating a divisible test property in the test ecosystem
        node.counos_sendissuancefixed(address, 2, 2, 0, "Z_TestCat", "Z_TestSubCat", "Z_DivisTestProperty", "Z_TestURL", "Z_TestData", "10000000")
        node.generatetoaddress(1, coinbase_address)
        ...
        # Seeding with 50.00 COUNOS
        txid = node.counos_send(address, addresses[1], 1, "50")
        node.generatetoaddress(1, coinbase_address)

        # Checking the transaction was valid...
        result = node.counos_gettransaction(txid)
        assert_equal(result['valid'], True)

        # Seeding with 100.00 COUNOS
        txid = node.counos_send(address, addresses[2], 1, "100")
        node.generatetoaddress(1, coinbase_address)
        ...
        # Seeding with 150.00 COUNOS
        txid = node.counos_send(address, addresses[3], 1, "150")
        node.generatetoaddress(1, coinbase_address)
        ...
        # Seeding with 200.00 COUNOS
        txid = node.counos_send(address, addresses[4], 1, "200")
        node.generatetoaddress(1, coinbase_address)
        ...
        txid = node.counos_sendactivation(address, 9, activation_block, 999)
        node.generatetoaddress(1, coinbase_address)
        ...
        featureid = node.counos_getactivations()['completedactivations']
        found = False
        ...
        # Testing a trade against self where the first token is COUNOS
        txidb = node.counos_sendtrade(address, 1, "1.0", 3, "2000")
        node.generatetoaddress(1, coinbase_address)
        ...
        txida = node.counos_sendtrade(address, 3, "2000", 5, "1.0")
        node.generatetoaddress(1, coinbase_address)

        # Checking the transaction was valid...
        result = node.counos_gettransaction(txida)
        assert_equal(result['valid'], True)

        txidb = node.counos_sendtrade(address, 5, "1.0", 3, "2000")
        node.generatetoaddress(1, coinbase_address)

        # Checking the transaction was valid...
        result = node.counos_gettransaction(txidb)
        assert_equal(result['valid'], True)
        ...
        txida = node.counos_sendtrade(address, 3, "10000", 5, "1.0")
        node.generatetoaddress(1, coinbase_address)
        ...
        txidb = node.counos_sendtrade(address, 5, "1.0", 3, "10000")
        node.generatetoaddress(1, coinbase_address)
        ...
        txida = node.counos_sendtrade(address, 6, "0.00002000", 5, "1.0")
        node.generatetoaddress(1, coinbase_address)
        ...
        txidb = node.counos_sendtrade(address, 5, "1.0", 6, "0.00002000")
        node.generatetoaddress(1, coinbase_address)
        ...
        txida = node.counos_sendtrade(address, 6, "0.1", 5, "1.0")
        node.generatetoaddress(1, coinbase_address)
        ...
        txidb = node.counos_sendtrade(address, 5, "1.0", 6, "0.1")
        node.generatetoaddress(1, coinbase_address)
        ...
        for x in range(5):
            result = node.counos_sendtrade(address, 6, "39.96", 5, "1.0")
            node.generatetoaddress(1, coinbase_address)

            # Checking the transaction was valid...
            result= node.counos_gettransaction(result)
            assert_equal(result['valid'], True)

            result = node.counos_sendtrade(address, 5, "1.0", 6, "39.96")
            node.generatetoaddress(1, coinbase_address)
        ...
        txida = node.counos_sendtrade(address, 6, "0.09999999", 5, "0.8")
        txidb = node.counos_sendtrade(address, 5, "0.8", 6, "0.09999999")
        node.generatetoaddress(1, coinbase_address)
        ...
        result = node.counos_sendtrade(address, 6, "0.00002000", 5, "1.0")
        node.generatetoaddress(1, coinbase_address)
        ...
        result = node.counos_sendtrade(address, 5, "1.0", 6, "0.00002000")
        node.generatetoaddress(1, coinbase_address)
        ...
        for x in range(9):
            result = node.counos_sendtrade(address, 2147483651, "20000", 2147483652, "10.0")
            node.generatetoaddress(1, coinbase_address)
            ...
            result = node.counos_sendtrade(address, 2147483652, "10.0", 2147483651, "20000")
            node.generatetoaddress(1, coinbase_address)
