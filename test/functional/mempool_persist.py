...
By default, counoshd will dump mempool on shutdown and
...
class MempoolPersistTest(CounosHTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent counoshd from writing mempool.dat to disk. Verify that `savemempool` fails")
