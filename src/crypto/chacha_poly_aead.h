...
#ifndef COUNOSH_CRYPTO_CHACHA_POLY_AEAD_H
#define COUNOSH_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@counosh.
 *
 ...
 *
 * The chacha20-poly1305@counosh combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@counosh cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@counosh are relatively fast in
...
#endif // COUNOSH_CRYPTO_CHACHA_POLY_AEAD_H
