// Copyright (c) 2015-2018 The CounosH Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef COUNOSH_ZMQ_ZMQABSTRACTNOTIFIER_H
#define COUNOSH_ZMQ_ZMQABSTRACTNOTIFIER_H
...
#endif // COUNOSH_ZMQ_ZMQABSTRACTNOTIFIER_H
