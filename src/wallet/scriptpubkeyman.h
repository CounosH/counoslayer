...
#ifndef COUNOSH_WALLET_SCRIPTPUBKEYMAN_H
#define COUNOSH_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The CounosH Core wallet was originally a collection of unrelated private
...
#endif // COUNOSH_WALLET_SCRIPTPUBKEYMAN_H
