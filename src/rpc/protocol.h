...
#ifndef COUNOSH_RPC_PROTOCOL_H
#define COUNOSH_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in counoshd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< CounosH is not connected
