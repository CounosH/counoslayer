...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "counos_sendadddelegate", 1, "propertyid" },
    { "counos_sendremovedelegate", 1, "propertyid" },
    ...
    { "counos_sendnonfungible", 2, "propertyid"},
    { "counos_sendnonfungible", 3, "tokenstart"},
    { "counos_sendnonfungible", 4, "tokenend"},
    { "counos_setnonfungibledata", 0, "propertyid"},
    { "counos_setnonfungibledata", 1, "tokenstart"},
    { "counos_setnonfungibledata", 2, "tokenend"},
    { "counos_setnonfungibledata", 3, "issuer"},
    ...
    { "counos_createpayload_adddelegate", 0, "propertyid" },
    { "counos_createpayload_removedelegate", 0, "propertyid" },
    { "counos_createpayload_sendnonfungible", 0, "propertyid"},
