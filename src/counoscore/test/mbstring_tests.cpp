#include <counoscore/rpcmbstring.h>
...
BOOST_FIXTURE_TEST_SUITE(counoscore_mbstring_tests, BasicTestingSetup)
...
BOOST_AUTO_TEST_CASE(counos_getproperty_2147483662)
{
    BOOST_CHECK_EQUAL(
            "{"
