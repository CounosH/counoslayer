...
BOOST_FIXTURE_TEST_SUITE(counoscore_marker_tests, BasicTestingSetup)
...
{
    {
        ...
        CTransaction tx(mutableTx);
        BOOST_CHECK_EQUAL(GetEncodingClass(tx, nBlock), COUNOS_CLASS_A);
    }
    {
...
{
    {
        ...
        CTransaction tx(mutableTx);
        BOOST_CHECK_EQUAL(GetEncodingClass(tx, nBlock), COUNOS_CLASS_B);
    }
    {
...
{
    {
        ...
        CTransaction tx(mutableTx);
        BOOST_CHECK_EQUAL(GetEncodingClass(tx, nBlock), COUNOS_CLASS_C);
    }
    {
        int nBlock = std::numeric_limits<int>::max();
