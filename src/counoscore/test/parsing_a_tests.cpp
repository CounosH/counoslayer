...
BOOST_FIXTURE_TEST_SUITE(counoscore_parsing_a_tests, BasicTestingSetup)
...
{
    {
        ...
        txOutputs.push_back(createTxOut(6000, "cch1q6gj3g8v4zekfq9eygwynj5fjr9mukjvaclzgam"));
    ...
    }
    {
        ...
        std::vector<CTxOut> txOutputs;
        txOutputs.push_back(createTxOut(9001, "cch1q6gj3g8v4zekfq9eygwynj5fjr9mukjvaclzgam"));
