...
BOOST_FIXTURE_TEST_SUITE(counoscore_parsing_c_tests, BasicTestingSetup)
...
{
    {
        ...
        {
            CScript scriptPubKey;
            scriptPubKey << OP_RETURN << ParseHex("434f4e530000111122223333");
            CTxOut txOut = CTxOut(0, scriptPubKey);
            txOutputs.push_back(txOut);
        }
        {
        ...
        {
            CScript scriptPubKey;
            scriptPubKey << OP_RETURN << ParseHex("434f4e530001000200030004");
            CTxOut txOut = CTxOut(0, scriptPubKey);
            txOutputs.push_back(txOut);
        }
        {
            CScript scriptPubKey;
            scriptPubKey << OP_RETURN << ParseHex("434f4e53");
            CTxOut txOut = CTxOut(0, scriptPubKey);
            txOutputs.push_back(txOut);
        }
        CTransaction dummyTx = TxClassC(txInputs, txOutputs);
...
{
    {
        ...
        {
            CScript scriptPubKey;
            scriptPubKey << OP_RETURN << ParseHex("434f4e531222222222222222222222222223");
            CTxOut txOut = CTxOut(0, scriptPubKey);
            txOutputs.push_back(txOut);
        }
        {
            CScript scriptPubKey;
            scriptPubKey << OP_RETURN << ParseHex("434f4e534555555555555555555555555556");
            CTxOut txOut = CTxOut(5, scriptPubKey);
            txOutputs.push_back(txOut);
        }
        {
            CScript scriptPubKey;
            scriptPubKey << OP_RETURN << ParseHex("434f4e53788888888889");
            CTxOut txOut = CTxOut(0, scriptPubKey);
            txOutputs.push_back(txOut);
        }
        {
        ...
        {
            CScript scriptPubKey;
            scriptPubKey << OP_RETURN << ParseHex("434f4e53ffff11111111111111111111"
...
BOOST_AUTO_TEST_CASE(multiple_op_return_pushes)
{
    ...
    }
    {
        ...
        std::vector<CTxOut> txOutputs;
        {
            CScript scriptPubKey;
            scriptPubKey << OP_RETURN;
            scriptPubKey << ParseHex("434f4e5300000000000000010000000006dac2c0");
    ...
    }
    {
        ...
        std::vector<CTxOut> txOutputs;
        {
          CScript scriptPubKey;
          scriptPubKey << OP_RETURN;
          scriptPubKey << ParseHex("434f4e53");
