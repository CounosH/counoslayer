...
BOOST_FIXTURE_TEST_SUITE(counoscore_sender_bycontribution_tests, BasicTestingSetup)
 ...
 *
 * Note: it reflects the behavior of Counos Core, but this edge case is not specified.
 */
