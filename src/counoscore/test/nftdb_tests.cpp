...
BOOST_FIXTURE_TEST_SUITE(counoscore_nftdb_tests, BasicTestingSetup)

BOOST_AUTO_TEST_CASE(nftdb_test_sequence)
{
    LOCK(cs_tally);
    std::unique_ptr<CMPNonFungibleTokensDB> UITDb{new CMPNonFungibleTokensDB(GetDataDir() / "COUNOS_nftdb", true)};
