...
BOOST_FIXTURE_TEST_SUITE(counoscore_transaction_utility, BasicTestingSetup)
...
CTxOut PayToPubKeyHash_Exodus()
{
    ...
    int64_t amount = CounosGetDustThreshold(scriptPubKey);
...
{
    CScript scriptPubKey;
    scriptPubKey << OP_RETURN << ParseHex("434f4e5300000000000000070000000006dac2c0");
