...
BOOST_FIXTURE_TEST_SUITE(counoscore_encoding_b_tests, BasicTestingSetup)
...
BOOST_AUTO_TEST_CASE(class_b_empty)
{
    ...
    BOOST_CHECK(CounosCore_Encode_ClassB(strSeed, pubKey, vchPayload, vTxOuts));
    ...
    BOOST_CHECK_EQUAL(EncodeDestination(dest), "cch1q6gj3g8v4zekfq9eygwynj5fjr9mukjvaclzgam");
}
