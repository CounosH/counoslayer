#ifndef COUNOSH_COUNOSCORE_SCRIPT_H
#define COUNOSH_COUNOSCORE_SCRIPT_H
...
int64_t CounosGetDustThreshold(const CScript& scriptPubKey);
...
#endif // COUNOSH_COUNOSCORE_SCRIPT_H
