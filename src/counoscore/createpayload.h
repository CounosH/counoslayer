#ifndef COUNOSH_COUNOSCORE_CREATEPAYLOAD_H
#define COUNOSH_COUNOSCORE_CREATEPAYLOAD_H
...
std::vector<unsigned char> CreatePayload_CounosCoreAlert(uint16_t alertType, uint32_t expiryValue, const std::string& alertMessage);
...
#endif // COUNOSH_COUNOSCORE_CREATEPAYLOAD_H
