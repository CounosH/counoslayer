...
static UniValue counos_sendnonfungible(const JSONRPCRequest& request)
{
    std::shared_ptr<CWallet> const wallet = GetWalletForJSONRPCRequest(request);
    std::unique_ptr<interfaces::Wallet> pwallet = interfaces::MakeWallet(wallet);

    RPCHelpMan{"counos_sendnonfungible",
               ...
               RPCExamples{
                       HelpExampleCli("counos_sendnonfungible", "\"3M9qvHKtgARhqcMtM5cRT9VaiDJ5PSfQGY\" \"37FaKponF7zqoMLUjEiko25pDiuVH5YLEa\" 70 1 1000")
                       + HelpExampleRpc("counos_sendnonfungible", "\"3M9qvHKtgARhqcMtM5cRT9VaiDJ5PSfQGY\", \"37FaKponF7zqoMLUjEiko25pDiuVH5YLEa\", 70, 1, 1000")
               }
    }.Check(request);
...
static UniValue counos_setnonfungibledata(const JSONRPCRequest& request)
{
    std::shared_ptr<CWallet> const wallet = GetWalletForJSONRPCRequest(request);
    std::unique_ptr<interfaces::Wallet> pwallet = interfaces::MakeWallet(wallet);

    RPCHelpMan{"counos_setnonfungibledata",
               ...
               RPCExamples{
                       HelpExampleCli("counos_setnonfungibledata", "70 50 60 true \"string data\"")
                       + HelpExampleRpc("counos_setnonfungibledata", "70, 55, 60, true, \"string data\"")
               }
    }.Check(request);
...
static UniValue counos_sendadddelegate(const JSONRPCRequest& request)
{
    std::shared_ptr<CWallet> const wallet = GetWalletForJSONRPCRequest(request);
    std::unique_ptr<interfaces::Wallet> pwallet = interfaces::MakeWallet(wallet);

    RPCHelpMan{"counos_sendadddelegate",
               ...
               RPCExamples{
                       HelpExampleCli("counos_sendadddelegate", "\"12GftZCQ3vwubWmRCmnfZAHdDWXj6ujenx\" 21 \"14TG9NsTxk2fvH8iGiFcVbquC5NPhHcFjh\"")
                       + HelpExampleRpc("counos_sendadddelegate", "\"12GftZCQ3vwubWmRCmnfZAHdDWXj6ujenx\", 21, \"14TG9NsTxk2fvH8iGiFcVbquC5NPhHcFjh\"")
               }
    }.Check(request);
...
static UniValue counos_sendremovedelegate(const JSONRPCRequest& request)
{
    std::shared_ptr<CWallet> const wallet = GetWalletForJSONRPCRequest(request);
    std::unique_ptr<interfaces::Wallet> pwallet = interfaces::MakeWallet(wallet);

    RPCHelpMan{"counoa_sendremovedelegate",
               ...
               RPCExamples{
                       HelpExampleCli("counos_sendremovedelegate", "\"12GftZCQ3vwubWmRCmnfZAHdDWXj6ujenx\" 21 \"14TG9NsTxk2fvH8iGiFcVbquC5NPhHcFjh\"")
                       + HelpExampleRpc("counos_sendremovedelegate", "\"12GftZCQ3vwubWmRCmnfZAHdDWXj6ujenx\", 21, \"14TG9NsTxk2fvH8iGiFcVbquC5NPhHcFjh\"")
               }
    }.Check(request);
...
{ //  category                             name                            actor (function)               okSafeMode
  //  ------------------------------------ ------------------------------- ------------------------------ ----------
    ...
    { "counos layer (transaction creation)", "counos_sendnonfungible",         &counos_sendnonfungible,         {"fromaddress", "toaddress", "propertyid", "tokenstart", "tokenend", "redeemaddress", "referenceamount"} },
    { "counos layer (transaction creation)", "counos_setnonfungibledata",      &counos_setnonfungibledata,      {"propertyid", "tokenstart", "tokenend", "issuer", "data"} },
    ...
    { "counos layer (transaction creation)", "counos_sendadddelegate",         &counos_sendadddelegate,         {"fromaddress", "propertyid", "delegateaddress"} },
    { "counos layer (transaction creation)", "counos_sendremovedelegate",      &counos_sendremovedelegate,      {"fromaddress", "propertyid", "delegateaddress"} },
