...
!define PRODUCTVERSION 0.10.0.0
!define VERSION 0.10.0.0
!define COMPANY "Counos Foundation"
...
VIAddVersionKey ProductName "Counos Core"
...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-counosh executable and locales:
    Delete /REBOOTOK $INSTDIR\counoscore.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\counoscore-qt.exe
    ...
    WriteRegStr HKCR "counosh" "URL Protocol" ""
    WriteRegStr HKCR "counosh" "" "URL:CounosH"
    WriteRegStr HKCR "counosh\DefaultIcon" "" $INSTDIR\counoscore-qt.exe
    WriteRegStr HKCR "counosh\shell\open\command" "" '"$INSTDIR\counoscore-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\counoscore-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMSTARTUP\Counos Core.lnk"
