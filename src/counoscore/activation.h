#ifndef COUNOSH_COUNOSCORE_ACTIVATION_H
#define COUNOSH_COUNOSCORE_ACTIVATION_H
...
/** Determines whether the sender is an authorized source for Counos Core activations. */
...
#endif // COUNOSH_COUNOSCORE_ACTIVATION_H
