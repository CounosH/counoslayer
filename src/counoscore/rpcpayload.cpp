...
static UniValue counos_createpayload_simplesend(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_simplesend",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_simplesend", "1 \"100.0\"")
           + HelpExampleRpc("counos_createpayload_simplesend", "1, \"100.0\"")
       }
    }.Check(request);
...
static UniValue counos_createpayload_sendall(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_sendall",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_sendall", "2")
           + HelpExampleRpc("counos_createpayload_sendall", "2")
       }
    }.Check(request);
...
UniValue counos_createpayload_sendnonfungible(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_sendnonfungible",
               ...
               RPCExamples{
                       HelpExampleCli("counos_createpayload_sendnonfungible", "70 1 1000")
                       + HelpExampleRpc("counosa_createpayload_sendnonfungible", "70, 1, 1000")
               }
    }.Check(request);
...
static UniValue counos_createpayload_setnonfungibledata(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_setnonfungibledata",
               ...
               RPCExamples{
                       HelpExampleCli("counos_createpayload_setnonfungibledata", "70 50 60 true \"string data\"")
                       + HelpExampleRpc("counos_createpayload_setnonfungibledata", "70, 50, 60, true, \"string data\"")
               }
    }.Check(request);
...
static UniValue counos_createpayload_sendtomany(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_sendtomany",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_sendtomany", "1 '[{\"output\": 2, \"amount\": \"10.5\"}, {\"output\": 3, \"amount\": \"0.5\"}]'")
           + HelpExampleRpc("counos_createpayload_sendtomany", "1, '[{\"output\": 2, \"amount\": \"10.5\"}, {\"output\": 3, \"amount\": \"0.5\"}]'")
       }
    }.Check(request);
...
static UniValue counos_createpayload_dexsell(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_dexsell",
       "\nCreate a payload to place, update or cancel a sell offer on the traditional distributed COUNOS/CCH exchange.\n",
       {
           {"propertyidforsale", RPCArg::Type::NUM, RPCArg::Optional::NO, " the identifier of the tokens to list for sale (must be 1 for COUN or 2 for TCOUN)\n"},
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_dexsell", "1 \"1.5\" \"0.75\" 25 \"0.0005\" 1")
           + HelpExampleRpc("counos_createpayload_dexsell", "1, \"1.5\", \"0.75\", 25, \"0.0005\", 1")
       }
    }.Check(request);
    ...
    if (action <= CMPTransaction::UPDATE) { // actions 3 permit zero values, skip check
        ...
        amountDesired = ParseAmount(request.params[2], true); // CCH is divisible
...
static UniValue counos_createpayload_dexaccept(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_dexaccept",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_dexaccept", "1 \"15.0\"")
           + HelpExampleRpc("counos_createpayload_dexaccept", "1, \"15.0\"")
       }
    }.Check(request);
...
static UniValue counos_createpayload_sto(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_sto",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_sto", "3 \"5000\"")
           + HelpExampleRpc("counos_createpayload_sto", "3, \"5000\"")
       }
    }.Check(request);
...
static UniValue counos_createpayload_issuancefixed(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_issuancefixed",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_issuancefixed", "2 1 0 \"Companies\" \"CounosH Mining\" \"Quantum Miner\" \"\" \"\" \"1000000\"")
           + HelpExampleRpc("counos_createpayload_issuancefixed", "2, 1, 0, \"Companies\", \"CounosH Mining\", \"Quantum Miner\", \"\", \"\", \"1000000\"")
       }
    }.Check(request);
...
static UniValue counos_createpayload_issuancecrowdsale(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_issuancecrowdsale",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_issuancecrowdsale", "2 1 0 \"Companies\" \"CounosH Mining\" \"Quantum Miner\" \"\" \"\" 2 \"100\" 1483228800 30 2")
           + HelpExampleRpc("counos_createpayload_issuancecrowdsale", "2, 1, 0, \"Companies\", \"CounosH Mining\", \"Quantum Miner\", \"\", \"\", 2, \"100\", 1483228800, 30, 2")
       }
    }.Check(request);
...
static UniValue counos_createpayload_issuancemanaged(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_issuancemanaged",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_issuancemanaged", "2 1 0 \"Companies\" \"CounosH Mining\" \"Quantum Miner\" \"\" \"\"")
           + HelpExampleRpc("counos_createpayload_issuancemanaged", "2, 1, 0, \"Companies\", \"CounosH Mining\", \"Quantum Miner\", \"\", \"\"")
       }
    }.Check(request);
...
static UniValue counos_createpayload_closecrowdsale(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_closecrowdsale",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_closecrowdsale", "70")
           + HelpExampleRpc("counos_createpayload_closecrowdsale", "70")
       }
    }.Check(request);
...
static UniValue counos_createpayload_grant(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_grant",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_grant", "51 \"7000\"")
           + HelpExampleRpc("counos_createpayload_grant", "51, \"7000\"")
       }
    }.Check(request);
...
static UniValue counos_createpayload_revoke(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_revoke",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_revoke", "51 \"100\"")
           + HelpExampleRpc("counos_createpayload_revoke", "51, \"100\"")
       }
    }.Check(request);
...
static UniValue counos_createpayload_changeissuer(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_changeissuer",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_changeissuer", "3")
           + HelpExampleRpc("counos_createpayload_changeissuer", "3")
       }
    }.Check(request);
...
static UniValue counos_createpayload_trade(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_trade",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_trade", "31 \"250.0\" 1 \"10.0\"")
           + HelpExampleRpc("counos_createpayload_trade", "31, \"250.0\", 1, \"10.0\"")
       }
    }.Check(request);
...
static UniValue counos_createpayload_canceltradesbyprice(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_canceltradesbyprice",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_canceltradesbyprice", "31 \"100.0\" 1 \"5.0\"")
           + HelpExampleRpc("counos_createpayload_canceltradesbyprice", "31, \"100.0\", 1, \"5.0\"")
       }
    }.Check(request);
...
static UniValue counos_createpayload_canceltradesbypair(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_canceltradesbypair",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_canceltradesbypair", "1 31")
           + HelpExampleRpc("counos_createpayload_canceltradesbypair", "1, 31")
       }
    }.Check(request);
...
static UniValue counos_createpayload_cancelalltrades(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_cancelalltrades",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_cancelalltrades", "1")
           + HelpExampleRpc("counos_createpayload_cancelalltrades", "1")
       }
    }.Check(request);
...
static UniValue counos_createpayload_enablefreezing(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_enablefreezing",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_enablefreezing", "3")
           + HelpExampleRpc("counos_createpayload_enablefreezing", "3")
       }
    }.Check(request);
...
static UniValue counos_createpayload_disablefreezing(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_disablefreezing",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_disablefreezing", "3")
           + HelpExampleRpc("counos_createpayload_disablefreezing", "3")
       }
    }.Check(request);
...
static UniValue counos_createpayload_freeze(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_freeze",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_freeze", "\"3HTHRxu3aSDV4deakjC7VmsiUp7c6dfbvs\" 1 \"100\"")
           + HelpExampleRpc("counos_createpayload_freeze", "\"3HTHRxu3aSDV4deakjC7VmsiUp7c6dfbvs\", 1, \"100\"")
       }
    }.Check(request);
...
static UniValue counos_createpayload_unfreeze(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_unfreeze",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_unfreeze", "\"3HTHRxu3aSDV4deakjC7VmsiUp7c6dfbvs\" 1 \"100\"")
           + HelpExampleRpc("counos_createpayload_unfreeze", "\"3HTHRxu3aSDV4deakjC7VmsiUp7c6dfbvs\", 1, \"100\"")
       }
    }.Check(request);
...
static UniValue counos_createpayload_adddelegate(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_adddelegate",
               ...
               RPCExamples{
                       HelpExampleCli("counos_createpayload_adddelegate", "21")
                       + HelpExampleRpc("counos_createpayload_adddelegate", "21")
               }
    }.Check(request);
...
static UniValue counos_createpayload_removedelegate(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_removedelegate",
               ...
               RPCExamples{
                       HelpExampleCli("counos_createpayload_removedelegate", "21")
                       + HelpExampleRpc("counos_createpayload_removedelegate", "21")
               }
    }.Check(request);
...
static UniValue counos_createpayload_anydata(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createpayload_anydata",
       ...
       RPCExamples{
           HelpExampleCli("counos_createpayload_anydata", "\"646578782032303230\"")
           + HelpExampleRpc("counos_createpayload_anydata", "\"646578782032303230\"")
       }
    }.Check(request);
...
{ //  category                         name                                      actor (function)                         okSafeMode
  //  -------------------------------- ----------------------------------------- ---------------------------------------- ----------
    { "counos layer (payload creation)", "counos_createpayload_simplesend",          &counos_createpayload_simplesend,          {"propertyid", "amount"} },
    { "counos layer (payload creation)", "counos_createpayload_sendall",             &counos_createpayload_sendall,             {"ecosystem"} },
    { "counos layer (payload creation)", "counos_createpayload_sendtomany",          &counos_createpayload_sendtomany,          {"propertyid", "mapping"} },
    { "counos layer (payload creation)", "counos_createpayload_dexsell",             &counos_createpayload_dexsell,             {"propertyidforsale", "amountforsale", "amountdesired", "paymentwindow", "minacceptfee", "action"} },
    { "counos layer (payload creation)", "counos_createpayload_dexaccept",           &counos_createpayload_dexaccept,           {"propertyid", "amount"} },
    { "counos layer (payload creation)", "counos_createpayload_sto",                 &counos_createpayload_sto,                 {"propertyid", "amount", "distributionproperty"} },
    { "counos layer (payload creation)", "counos_createpayload_grant",               &counos_createpayload_grant,               {"propertyid", "amount", "memo"} },
    { "counos layer (payload creation)", "counos_createpayload_revoke",              &counos_createpayload_revoke,              {"propertyid", "amount", "memo"} },
    { "counos layer (payload creation)", "counos_createpayload_changeissuer",        &counos_createpayload_changeissuer,        {"propertyid"} },
    { "counos layer (payload creation)", "counos_createpayload_trade",               &counos_createpayload_trade,               {"propertyidforsale", "amountforsale", "propertiddesired", "amountdesired"} },
    { "counos layer (payload creation)", "counos_createpayload_issuancefixed",       &counos_createpayload_issuancefixed,       {"ecosystem", "type", "previousid", "category", "subcategory", "name", "url", "data", "amount"} },
    { "counos layer (payload creation)", "counos_createpayload_issuancecrowdsale",   &counos_createpayload_issuancecrowdsale,   {"ecosystem", "type", "previousid", "category", "subcategory", "name", "url", "data", "propertyiddesired", "tokensperunit", "deadline", "earlybonus", "issuerpercentage"} },
    { "counos layer (payload creation)", "counos_createpayload_issuancemanaged",     &counos_createpayload_issuancemanaged,     {"ecosystem", "type", "previousid", "category", "subcategory", "name", "url", "data"} },
    { "counos layer (payload creation)", "counos_createpayload_closecrowdsale",      &counos_createpayload_closecrowdsale,      {"propertyid"} },
    { "counos layer (payload creation)", "counos_createpayload_canceltradesbyprice", &counos_createpayload_canceltradesbyprice, {"propertyidforsale", "amountforsale", "propertiddesired", "amountdesired"} },
    { "counos layer (payload creation)", "counos_createpayload_canceltradesbypair",  &counos_createpayload_canceltradesbypair,  {"propertyidforsale", "propertiddesired"} },
    { "counos layer (payload creation)", "counos_createpayload_cancelalltrades",     &counos_createpayload_cancelalltrades,     {"ecosystem"} },
    { "counos layer (payload creation)", "counos_createpayload_enablefreezing",      &counos_createpayload_enablefreezing,      {"propertyid"} },
    { "counos layer (payload creation)", "counos_createpayload_disablefreezing",     &counos_createpayload_disablefreezing,     {"propertyid"} },
    { "counos layer (payload creation)", "counos_createpayload_freeze",              &counos_createpayload_freeze,              {"toaddress", "propertyid", "amount"} },
    { "counos layer (payload creation)", "counos_createpayload_unfreeze",            &counos_createpayload_unfreeze,            {"toaddress", "propertyid", "amount"} },
    { "counos layer (payload creation)", "counos_createpayload_adddelegate",         &counos_createpayload_adddelegate,         {"propertyid"} },
    ...
    { "counos layer (payload creation)", "counos_createpayload_setnonfungibledata",  &counos_createpayload_setnonfungibledata,  {"propertyid", "tokenstart", "tokenend", "issuer", "data"} },
};
