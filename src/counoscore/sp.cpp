        ...
        std::pair<int64_t, int64_t>& tokens, bool& close_crowdsale)
{
    ...
    // Precision for all non-counosh values (bonus percentages, for example)
    ...
    // Precision for counosh amounts (satoshi)
...
{
    switch (ecosystem) {
        case COUNOS_PROPERTY_MSC: return "main";
        case COUNOS_PROPERTY_TMSC: return "test";
    }
