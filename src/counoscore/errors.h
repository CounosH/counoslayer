#ifndef COUNOSH_COUNOSCORE_ERRORS_H
#define COUNOSH_COUNOSCORE_ERRORS_H
...
enum MPRPCErrorCode
{
    ...
    MP_TX_IS_NOT_COUNOS_PROTOCOL    = -3336,  // No Counos Layer Protocol transaction.
...
inline std::string error_str(int ec) {
  ...
  switch (ec)
  {
      ...
      case MP_INPUT_NOT_IN_RANGE:
          ec_str = "Input value supplied larger than supported in Counos Layer Protocol";
          break;
      ...
      case PKT_ERROR_TRADEOFFER -47:
          ec_str = "Property for sale must be COUN or TCOUN";
          break;
      ...
      case PKT_ERROR_METADEX -35:
          ec_str = "One side of the trade must be COUN or TCOUN";
          break;
...
#endif // COUNOSH_COUNOSCORE_ERRORS_H
