#ifndef COUNOSH_COUNOSCORE_LOG_H
#define COUNOSH_COUNOSCORE_LOG_H
 ...
 */
#define MAKE_COUNOS_CORE_ERROR_AND_LOG_FUNC(n)                                    \
...
TINYFORMAT_FOREACH_ARGNUM(MAKE_COUNOS_CORE_ERROR_AND_LOG_FUNC)

#undef MAKE_COUNOS_CORE_ERROR_AND_LOG_FUNC


#endif // COUNOSH_COUNOSCORE_LOG_H
