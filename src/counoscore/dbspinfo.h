#ifndef COUNOSH_COUNOSCORE_DBSPINFO_H
#define COUNOSH_COUNOSCORE_DBSPINFO_H
...
private:
    // implied version of COUN and TCOUN so they don't hit the leveldb
    Entry implied_counos;
    Entry implied_tcounos;
...
#endif // COUNOSH_COUNOSCORE_DBSPINFO_H
