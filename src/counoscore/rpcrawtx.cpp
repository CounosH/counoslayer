...
static UniValue counos_decodetransaction(const JSONRPCRequest& request)
{
#ifdef ENABLE_WALLET
    ...
    RPCHelpMan{"counos_decodetransaction",
       ...
       RPCExamples{
           HelpExampleCli("counos_decodetransaction", "\"\" \"[{\\\"txid\\\":\\\"eeafb8c5b3be663f2ad0c00597a88f2896765b2ae30735791c7e476dce14af63\\\",\\\"vout\\\":1,\\\"scriptPubKey\\\":\\\"76a9149084c0bd89289bc025d0264f7f23148fb683d56c88ac\\\",\\\"value\\\":0.0001123}]\"")
           + HelpExampleRpc("counos_decodetransaction", "\"\", [{\"txid\":\"eeafb8c5b3be663f2ad0c00597a88f2896765b2ae30735791c7e476dce14af63\",\"vout\":1,\"scriptPubKey\":\"76a9149084c0bd89289bc025d0264f7f23148fb683d56c88ac\",\"value\":0.0001123}]")
       }
    }.Check(request);
...
static UniValue counos_createrawtx_opreturn(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createrawtx_opreturn",
       ...
       RPCExamples{
           HelpExampleCli("counos_createrawtx_opreturn", "\"01000000000000000000\" \"00000000000000020000000006dac2c0\"")
           + HelpExampleRpc("counos_createrawtx_opreturn", "\"01000000000000000000\", \"00000000000000020000000006dac2c0\"")
       }
    }.Check(request);
...
static UniValue counos_createrawtx_multisig(const JSONRPCRequest& request)
{
#ifdef ENABLE_WALLET
    std::shared_ptr<CWallet> const wallet = GetWalletForJSONRPCRequest(request);
    std::unique_ptr<interfaces::Wallet> pWallet = interfaces::MakeWallet(wallet);
    ...
    RPCHelpMan{"counos_createrawtx_multisig",
       ...
       RPCExamples{
           HelpExampleCli("counos_createrawtx_multisig", "\"0100000001a7a9402ecd77f3c9f745793c9ec805bfa2e14b89877581c734c774864247e6f50400000000ffffffff01aa0a0000000000001976a9146d18edfe073d53f84dd491dae1379f8fb0dfe5d488ac00000000\" \"00000000000000020000000000989680\" \"1LifmeXYHeUe2qdKWBGVwfbUCMMrwYtoMm\" \"0252ce4bdd3ce38b4ebbc5a6e1343608230da508ff12d23d85b58c964204c4cef3\"")
           + HelpExampleRpc("counos_createrawtx_multisig", "\"0100000001a7a9402ecd77f3c9f745793c9ec805bfa2e14b89877581c734c774864247e6f50400000000ffffffff01aa0a0000000000001976a9146d18edfe073d53f84dd491dae1379f8fb0dfe5d488ac00000000\", \"00000000000000020000000000989680\", \"1LifmeXYHeUe2qdKWBGVwfbUCMMrwYtoMm\", \"0252ce4bdd3ce38b4ebbc5a6e1343608230da508ff12d23d85b58c964204c4cef3\"")
       }
    }.Check(request);
...
static UniValue counos_createrawtx_input(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createrawtx_input",
       ...
       RPCExamples{
           HelpExampleCli("counos_createrawtx_input", "\"01000000000000000000\" \"b006729017df05eda586df9ad3f8ccfee5be340aadf88155b784d1fc0e8342ee\" 0")
           + HelpExampleRpc("counos_createrawtx_input", "\"01000000000000000000\", \"b006729017df05eda586df9ad3f8ccfee5be340aadf88155b784d1fc0e8342ee\", 0")
       }
    }.Check(request);
...
static UniValue counos_createrawtx_reference(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createrawtx_reference",
       ...
       RPCExamples{
           HelpExampleCli("counos_createrawtx_reference", "\"\" \"1CE8bBr1dYZRMnpmyYsFEoexa1YoPz2mfB\" 0.005")
           + HelpExampleRpc("counos_createrawtx_reference", "\"\", \"1CE8bBr1dYZRMnpmyYsFEoexa1YoPz2mfB\", 0.005")
       }
    }.Check(request);
...
static UniValue counos_createrawtx_change(const JSONRPCRequest& request)
{
    RPCHelpMan{"counos_createrawtx_change",
       ...
       RPCExamples{
           HelpExampleCli("counos_createrawtx_change", "\"\" \"[{\\\"txid\\\":\\\"6779a710fcd5f6fb0883ea3306360c3ad8c0a3c5de902768ec57ef3104e65eb1\\\",\\\"vout\\\":4,\\\"scriptPubKey\\\":\\\"76a9147b25205fd98d462880a3e5b0541235831ae959e588ac\\\",\\\"value\\\":0.00068257}]\" \"1CE8bBr1dYZRMnpmyYsFEoexa1YoPz2mfB\" 0.00003500 1")
           + HelpExampleRpc("counos_createrawtx_change", "\"\", [{\"txid\":\"6779a710fcd5f6fb0883ea3306360c3ad8c0a3c5de902768ec57ef3104e65eb1\",\"vout\":4,\"scriptPubKey\":\"76a9147b25205fd98d462880a3e5b0541235831ae959e588ac\",\"value\":0.00068257}], \"1CE8bBr1dYZRMnpmyYsFEoexa1YoPz2mfB\", 0.00003500, 1")
       }
    }.Check(request);
...
{ //  category                         name                          actor (function)             okSafeMode
  //  -------------------------------- ----------------------------- ---------------------------- ----------
    { "counos layer (raw transactions)", "counos_decodetransaction",     &counos_decodetransaction,     {"rawtx", "prevtxs", "height"} },
    { "counos layer (raw transactions)", "counos_createrawtx_opreturn",  &counos_createrawtx_opreturn,  {"rawtx", "payload"} },
    { "counos layer (raw transactions)", "counos_createrawtx_multisig",  &counos_createrawtx_multisig,  {"rawtx", "payload", "seed", "redeemkey"} },
    { "counos layer (raw transactions)", "counos_createrawtx_input",     &counos_createrawtx_input,     {"rawtx", "txid", "n"} },
    { "counos layer (raw transactions)", "counos_createrawtx_reference", &counos_createrawtx_reference, {"rawtx", "destination", "referenceamount"} },
    { "counos layer (raw transactions)", "counos_createrawtx_change",    &counos_createrawtx_change,    {"rawtx", "prevtxs", "destination", "fee", "position"} },
