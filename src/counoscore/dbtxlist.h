#ifndef COUNOSH_COUNOSCORE_DBTXLIST_H
#define COUNOSH_COUNOSCORE_DBTXLIST_H
...
public:
    ...
    int GetCounosTxsInBlockRange(int blockFirst, int blockLast, std::set<uint256>& retTxs);
...
#endif // COUNOSH_COUNOSCORE_DBTXLIST_H
