#ifndef COUNOSH_COUNOSCORE_COUNOSCORE_H
#define COUNOSH_COUNOSCORE_COUNOSCORE_H
...
// Counos Layer Transaction (Packet) Version
...
enum TransactionType {
  ...
  COUNOSCORE_MESSAGE_TYPE_DEACTIVATION  = 65533,
  COUNOSCORE_MESSAGE_TYPE_ACTIVATION    = 65534,
  COUNOSCORE_MESSAGE_TYPE_ALERT         = 65535
};
...
#define COUNOS_PROPERTY_CCH   0
#define COUNOS_PROPERTY_MSC   1
#define COUNOS_PROPERTY_TMSC  2
...
#endif // COUNOSH_COUNOSCORE_COUNOSCORE_H
