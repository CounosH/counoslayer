...
#ifndef COUNOSH_TEST_SCRIPTNUM10_H
#define COUNOSH_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from CounosH Core 0.10.0, for cross-comparison.
 */
public:
