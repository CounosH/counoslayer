...
static bool getDisclaimerDialogResult()
{
    ...
    "By default this software will use your existing Counosh wallet, including spending "
    "counoshs contained therein (for example for transaction fees or trading).\n\n"
    "The protocol and transaction processing rules for the Counos Layer are still under "
    "active development and are subject to change in future.\n\n"
    "Counos Core should be considered an alpha-level product, and you use it at your "
    "own risk. Neither the Counos Foundation nor the Counos Core developers assumes "
    "any responsibility for funds misplaced, mishandled, lost, or misallocated.\n\n"
    "Further, please note that this installation of Counos Core should be viewed as "
    "EXPERIMENTAL. Your wallet data, counoshs and Counos Layer tokens may be lost, "
    ...
    "PLEASE DO NOT use wallet(s) with significant amounts of counoshs or Counos Layer "
...
static bool showDisclaimer()
{
    ...
    return settings.value("CounosCore/fShowDisclaimer", true).toBool();
}
...
bool AskUserToAcknowledgeRisks()
{
    ...
    settings.setValue("CounosCore/fShowDisclaimer", !fAccepted);
