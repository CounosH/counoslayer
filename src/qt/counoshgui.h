...
private:
    ...
    QLabel *labelCounosPendingIcon = nullptr;
    QLabel *labelCounosPendingText = nullptr;
...
public Q_SLOTS:
    ...
    */
    ...
    /** Set the Counos pending transactions label **/
    void setCounosPendingStatus(bool pending);
...
public Q_SLOTS:
    ...
    /** Switch directly to Counos history tab */
    void gotoCounosHistoryTab();
    /** Switch directly to counosh history tab */
