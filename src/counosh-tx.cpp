...
static void SetupCounosHTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " counosh-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  counosh-tx [options] <hex-tx> [commands]  Update hex-encoded counosh transaction\n" +
            "or:     counosh-tx [options] -create [commands]   Create hex-encoded counosh transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded counosh transaction
